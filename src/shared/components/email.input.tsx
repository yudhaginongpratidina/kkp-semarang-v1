 ...
 * =========================================================
 */
type EmailInputProps<T extends React.ElementType> = {
    as?: T;
    label?: string;
    helperText?: string;
    error?: string;
...
> &
    VariantProps<typeof emailInputStyles>;
 ...
 * =========================================================
 */
const EmailInputInner = <T extends React.ElementType = 'input'>(
    ...
    return (
        <div className="w-full flex flex-col gap-1">
            ...
            <div className={emailInputStyles({ size, state: currentState })}>
 ...
 * =========================================================
 */
export const EmailInput = React.forwardRef(EmailInputInner) as <
    T extends React.ElementType = 'input',
>(
    props: EmailInputProps<T> & { ref?: React.Ref<any> },
) => React.ReactElement;
